...
@pytest.mark.integration
def test_close_investigation_detects_ambiguous_investigation_id(efs_client, test_efs, ecs_cleanup):
    """
    ...
    assert cluster_id_1 in result.stderr or cluster_id_2 in result.stderr, "Error should list conflicting cluster IDs"
